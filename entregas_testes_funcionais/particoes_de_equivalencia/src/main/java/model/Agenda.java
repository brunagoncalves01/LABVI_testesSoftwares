...
public class Agenda implements Agendamento{
	...
	public Evento agendar(Evento e) {
        ...
        evento.setDataInicial(evento.getMes() + "/" + evento.getDia() + "/" + evento.getAno() + " " + evento.getHora());
        //evento.setDataInicial("09/18/2020 01:00");
        evento.setDataFinal(evento.getMesFinal() + "/" + evento.getDiaFinal() + "/" + evento.getAnoFinal() + " " + evento.getHoraFinal());
        eventos.add(evento);
        return evento;
